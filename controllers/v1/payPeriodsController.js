...
import PayPeriod from '../../models/shift.js';


export const create = [
  // Validate and sanitize
  body('startDate', 'Start time is empty').trim().isLength({ min: 1 }).escape(),
  body('endDate', 'Shift length is empty').trim().isLength({ min: 1 }).escape(),
